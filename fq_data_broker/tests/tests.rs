...
mod data_broker_tests {
    ...
    #[test]
    fn retrieve_data_test_one_day_no_delete() {
        let curr_dir_res = std::env::set_current_dir("..");
        assert!(curr_dir_res.is_ok());
    ...
    #[test]
    fn retrieve_data_test_three_days() {
        let curr_dir_res = std::env::set_current_dir("..");
        assert!(curr_dir_res.is_ok());
        ...
        assert_eq!(broker.get_num_entries("AAPL".to_string(), HashedBarSize::Day), 2);
    }
